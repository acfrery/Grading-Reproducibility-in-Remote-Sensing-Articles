...
%DIF ADD GradingReproducibilityRS_R1.tex   Thu Aug 13 12:12:03 2020
...
Although Open data are not necessarily free data, the authors must at least provide free samples\DIFaddbegin \DIFadd{, and code to read and export them to freely available computational platforms}\DIFaddend .
...
\DIFaddbegin \DIFadd{The role of such committee is solely verifying the reproducibility of the article and, thus, the expertise of their members may be from outside the Remote Sensing community.
}\DIFaddend 
...
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{Canvas-Trello-Modelo4}
	\DIFaddendFL \caption{A Trello implementation of a Scientific Canvas}\label{Fig:ScientificCanvas}
\end{figure}
